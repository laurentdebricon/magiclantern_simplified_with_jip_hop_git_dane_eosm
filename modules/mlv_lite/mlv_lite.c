...
<<<<<<< HEAD
>>>>>>> 40e0f63b5 (mlv_lite.c:(EOSM cropmarks automation anamorphic frtp))
=======
...
>>>>>>> e0a726d9b (crop_rec.c,mlv_lite.c:(EOSM a lot of work getting rid of cropmarks and getting cropmarks corrected 2k frtp preset))
}
