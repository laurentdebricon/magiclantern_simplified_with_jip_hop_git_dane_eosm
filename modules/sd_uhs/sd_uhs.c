...
/* Returns if the card is busy, checks for photo being taken/written and video recording */
static int card_busy()
{
    /* TODO: perhaps add more/better checks for card IO here. */
    return lens_info.job_state || RECORDING;
}
